...
/// Puente con el `WalletNotificationListenerService` nativo (Android). Tolerante
/// a `MissingPluginException` (tests / plataformas sin el canal): degrada a "sin
/// permiso" / buffer vacío en vez de lanzar. Ver `MainActivity.kt`.
class WalletNotifications {
  static const _channel = MethodChannel('com.example.finanzas/wallet');
  ...
  /// Devuelve el buffer **sin** vaciarlo (para el visor de depuración).
